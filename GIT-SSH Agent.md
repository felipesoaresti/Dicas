...
Adicione o repositório remoto como destino:
     ...
     $git remote add origin git@github.com:felipesoaresti/app.git
...
Você deve ver algo assim:
    ...
    origin  git@github.com:felipesoaresti/app.git (fetch)
    origin  git@github.com:felipesoaresti/app.git (push)
...
Verificar no GitHub
Acesse o repositório no GitHub (https://github.com/felipesoaresti/app) para confirmar que os arquivos foram enviados corretamente.
